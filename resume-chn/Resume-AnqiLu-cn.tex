...
%------------------------------------------------
	...
	{CSL软件开发
		\begin{itemize}
			...
			\item 参加POC项目Heimdallr，用于Power机器的性能监控。负责系统监控仪表盘模块。{\footnotesize\addfontfeature{Color=lightgray} RRD Tools}
			\item 参与RDO (OpenStack on Redhat, CentOS, Fedora)在PPC64架构上的解决方案。主要负责核心组件的移植，高可用性 (HA)，以及自动化部署OpenStack。{\footnotesize\addfontfeature{Color=lightgray} OpenStack, IBM Power, Virtualization}
